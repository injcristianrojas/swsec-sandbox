		...
		<table>
				...
				<tr>
					<td class="hint-body">
						<ul class="hints">
						  	<li>
						  		<b>For Unvalidated Redirects and Forwards:</b> 
							...
							<li>
								...
								"http://www.google.com" as the URL passed to the 
								"forwardurl" parameter.
							</li>
							<li>
								If no Internet connection is available, try passing
								"http://localhost/mutillidae/capture-data.php" as the URL passed to the 
								"forwardurl" parameter.
							</li>
						</ul>
					</td>
