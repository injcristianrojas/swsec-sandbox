<?php
	if($_SESSION['loggedin'] == "True"){
		...
		$lAuthenticationStatusMessage = 
				'Logged In <span style="color:#990000;font-weight:bold;">' . 
				$lUserAuthorizationLevelText . "</span>: " . 
				$logged_in_user . " (" . 
...
<table class="main-table-frame" border="1px" cellspacing="0px" cellpadding="0px">
	...
	<tr>
			...
			<ul>
				<li style="border-color: #ffffff;border-style: solid;border-width: 1px">
					...
					<ul>
						...
						<li><a href="./index.php?do=toggle-enforce-ssl&page=<?php echo $lPage?>"><?php echo $lEnforceSSLLabel; ?></a></li>
					</ul>
				</li>
				<li style="border-color: #ffffff;border-style: solid;border-width: 1px">
					...
					<ul>
						...
						<li>
							<a href="http://sourceforge.net/projects/mutillidae/files/mutillidae-project/" target="_blank">
								Latest Version of NOWASP Mutillidae
							</a>
						</li>
		...
		<div>&nbsp;</div>
		<div class="label" style="text-align: center;">Developed by Adrian &quot;<a href="http://www.irongeek.com" target="_blank">Irongeek</a>&quot; Crenshaw and Jeremy Druin</div>
	</td>
