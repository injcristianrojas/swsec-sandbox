		...
		echo '
			<table>
				...
				<tr>
					<td class="hint-body">
						<br/>
						<span class="report-header">Buffer Overflow</span>
						<br/><br/>				
						<ul class="hints">
						  	<li>
						  	...
						  	<li> Try to overflow the variable which is created to hold the expanded "String to Repeat".
						  	The data type of this buffer is PHP:String.
						  	</li>
						  	<li>PHP:String can hold a lot of data but the size is not infinite.</li>
						  	<li>
						...
						<br/><br/>
						<span class="report-header">Parameter Addition</span>
						<br/><br/>						
						<ul class="hints">
						  	<li>
						  	...
						  	<li> Try adding a parameter and setting the value to a JavaScript. See if you
						  	can get the script to execute.
						  	</li>
						  	<li>Note: Escaping the context in which the parameters lands may be neccesary</li>
						</ul>
					</td>
				</tr>
			</table>'; 
