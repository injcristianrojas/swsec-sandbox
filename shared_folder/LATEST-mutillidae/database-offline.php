...
<table style="margin-left:auto; margin-right:auto;">
	<tr id="id-bad-page-tr">
		<td class="error-message" style="background-color: #FFFFFF;	">
			The database server appears to be offline. <?php echo "Server: ".MySQLHandler::$mMySQLDatabaseHost." Error: ".$lErrorMessage ?>
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
</table>
